...
enter_valid_choice:
        ...
        beq $v0, 51, search_for_UNNORMAL_by_patientID_by_input_test
...
LOOPthroughfile:
            ...
            move $t9, $a0 # Save the address of the buffer in $t9 to keep it without change

            jal checkIDexist # check for each line if the ID is in the file 
            ...
            beq $t6, 1, check_test_resultUnnormal
            jal gotoNEXTline
            beq $s7, 1, CorM
            j LOOPthroughfile
...
check_test_resultUnnormal: 
            ...
            jal line_by_line_function # f(a0) retrun F1 = test result in floating point, t4 = type of test, a0 = start of the next line
            ...
            HgBUNnormal:
                            ...
                            beq $s7, 1, CorM  # If the end of the file is reached, return to the menu
...
checkIdIfEqual:
    beq $t6, $t3, values_equal_OF_IDS # Compare sum of ASCII values
...
parseeString:
    ...
    li $t3, 1              # Will be used for the TENpower
...
endInteger:
    sw $t1, INTpart    # Store the integer part
...
search_for_UNNORMAL_by_patientID_by_input_test :
		...
		enter_valid_optioSearch:
				...
				move $v0,$a1
                    ...
                    li $t1, 49
                    beq $v0, $t1, hemoglobin_label_test_value_unnormal

                    li $t1, 50
                    beq $v0, $t1, blood_glucose_test_label_test_value_unnormal

                    li $t1, 51
                    beq $v0, $t1, ldl_cholesterol_label_test_value_unnormal

                    li $t1, 52
                    beq $v0, $t1, blood_pressure_test_label_test_value_unnormal
